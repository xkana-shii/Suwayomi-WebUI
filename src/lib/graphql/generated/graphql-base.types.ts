...
export type InstallMissingExtensionsFromBackupInput = {
    backup: Scalars['Upload']['input'];
    clientMutationId?: InputMaybe<Scalars['String']['input']>;
};

export type InstallMissingExtensionsFromBackupPayload = {
    __typename?: 'InstallMissingExtensionsFromBackupPayload';
    clientMutationId?: Maybe<Scalars['String']['output']>;
    installedExtensions: Array<ExtensionType>;
    matchedExtensionPkgNames: Array<Scalars['String']['output']>;
    requestedSources: Array<InstallMissingExtensionsFromBackupSource>;
    unmatchedSources: Array<InstallMissingExtensionsFromBackupSource>;
};

export type InstallMissingExtensionsFromBackupSource = {
    __typename?: 'InstallMissingExtensionsFromBackupSource';
...
export type Mutation = {
    ...
    installMissingExtensionsFromBackup: InstallMissingExtensionsFromBackupPayload;
    login: LoginPayload;
...
export type MutationInstallMissingExtensionsFromBackupArgs = {
...
export type PartialSettingsType = Settings & {
    ...
    serverUpdateChannel?: Maybe<Scalars['String']['output']>;
...
export type PartialSettingsTypeInput = {
    ...
    serverUpdateChannel?: InputMaybe<Scalars['String']['input']>;
...
export type SettingsType = Settings & {
    ...
    serverUpdateChannel: Scalars['String']['output'];
...
export type SourceType = {
    ...
    name: Scalars['String']['output'];
    nonLibraryCount: Scalars['Int']['output'];
